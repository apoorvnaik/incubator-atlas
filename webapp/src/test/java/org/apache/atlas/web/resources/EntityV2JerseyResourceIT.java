...
//        });
    ...
    public void testGetEntityByAttribute() throws Exception {
        ...
        String qualifiedName = (String) hiveDB.getAttribute("qualifiedName");
        //get entity by attribute
        AtlasEntity byAttribute = entitiesClientV2.getEntityByAttribute(DATABASE_TYPE, "qualifiedName", qualifiedName);
        assertEquals(byAttribute.getTypeName(), DATABASE_TYPE);
        assertEquals(byAttribute.getAttribute("qualifiedName"), qualifiedName);
    }
...
//        }
    ...
    public void testGetTraitNames() throws Exception {
        ...
        assertEquals(classifications.getList().size(), 7);
    }
...
//            assertEquals(ex.getStatus(), ClientResponse.Status.NOT_FOUND);
    ...
    public void testDeleteEntities() throws Exception {
        ...
        db1.setAttribute("qualifiedName", dbName1);
        ...
        db2.setAttribute("qualifiedName", dbName2);
    ...
    public void testDeleteEntityByUniqAttribute() throws Exception {
        ...
        EntityMutationResponse deleteResponse = entitiesClientV2.deleteEntityByAttribute(DATABASE_TYPE, "qualifiedName", qualifiedName);
