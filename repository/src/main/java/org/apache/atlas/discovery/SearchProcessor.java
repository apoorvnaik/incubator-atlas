...
public abstract class SearchProcessor {
        ...
        if (filterCriteria != null) {
            ...
            if (condition != null) {
                ...
                try {
                    ...
                    tagFilterQuery.append(toGremlinComparisonQuery(qualifiedAttributeName, operator, attributeValue));
                } catch (AtlasBaseException e) {
                    LOG.warn(e.getMessage());
                }
    ...
    private String toGremlinComparisonQuery(String qualifiedAttrName, SearchParameters.Operator operator, String attrValue) {
        ...
        if (org.apache.commons.lang3.StringUtils.isNotEmpty(queryTemplate)) {
            return String.format(queryTemplate, qualifiedAttrName, attrValue);
        } else {
            return EMPTY_STRING;
        }
    }
