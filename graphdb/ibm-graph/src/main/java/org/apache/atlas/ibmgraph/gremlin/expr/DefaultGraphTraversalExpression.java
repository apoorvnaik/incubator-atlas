...
/**
 * Expression that gets the default graph traversal.
 */
public class DefaultGraphTraversalExpression extends AbstractGroovyExpression {

    public DefaultGraphTraversalExpression() {
    ...
    public void generateGroovy(GroovyGenerationContext context) {
        ...
        GroovyExpression result = new FunctionCallExpression(graph, "traversal");
