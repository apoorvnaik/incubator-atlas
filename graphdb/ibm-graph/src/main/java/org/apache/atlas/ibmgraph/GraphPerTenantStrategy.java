 ...
 */
public class GraphPerTenantStrategy implements TenantGraphStrategy {

    private static final String IS_GRAPHDB_VERTEX = "__is_graphdb_vertex";

    public GraphPerTenantStrategy() throws Exception{
    ...
    public String getUserTenantId() {
       ...
       if(tenantId == null) {
           tenantId = GraphDatabaseConfiguration.INSTANCE.getGraphName();
       }
       return tenantId;
    }
