...
public class UpdateScriptLoggingOnTest  {

    private AtlasGraph<?,?> graph = null;

    //this test must be run in a forked jvm
    static {
        System.setProperty("log4j.configuration","update-logging-on-log4j.xml");
    }
    ...
    public <V,E> void testUpdateLoggingEnabled() {
        assertEquals(true, LoggerFactory.getLogger("GraphUpdateScriptLogger").isDebugEnabled());
    }
